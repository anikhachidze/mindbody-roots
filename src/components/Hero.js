  ...
  return (
    <Wrap>
      <div>
        ...
        <H1>Be Friend of your mind.</H1>
        <Lead>
          Explore practical articles about the unconscious mind, daily
          discipline, physical wellbeing, and the small routines that make a
          healthier life easier to repeat.
        </Lead>
        <Actions>
      ...
      <Card>
        ...
        <Mini>
          MindBody Roots is built for calm learning: short articles, grounded
          motivation, and tools that support healthier routines without hype.
        </Mini>
      </Card>
    </Wrap>
  );
